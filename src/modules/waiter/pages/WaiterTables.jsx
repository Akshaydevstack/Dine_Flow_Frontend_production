...
export default function ModernTables() {
  ...
  // Reorder for an already-occupied table — skip the occupancy check
  const handleReorder = (table_id) => {
    localStorage.setItem("table_id", table_id);
    setSelectedTableId(table_id);
    navigate("/waiter/menu");
  };
              ...
              return viewMode === "grid" ? (
                ...
                >
                  ...
                  {isSelected ? (
                    ...
                    /* Occupied — Reorder + View Bill side by side */
                    <div className="flex gap-1.5">
                      <button
                        onClick={() => handleReorder(table.public_id)}
                        className="flex-1 py-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-xl text-xs font-bold shadow-md shadow-amber-500/20 active:scale-95 transition-transform flex items-center justify-center gap-1"
                      >
                      ...
                      <button
                        ...
                        className="flex-1 py-2 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl text-xs font-bold active:scale-95 transition-transform flex items-center justify-center gap-1"
                      >
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    {isSelected ? (
                      ...
                      /* Occupied — Reorder + Bill side by side */
                      <div className="flex gap-1 flex-shrink-0">
                        <button
                          onClick={() => handleReorder(table.public_id)}
                          className="px-2 py-1.5 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-lg text-[10px] font-bold shadow-md shadow-amber-500/20 active:scale-95 transition-transform flex items-center gap-1"
                        >
                          <Star className="w-3 h-3" />
                          Reorder
                        </button>
                        <button
                          ...
                          className="px-2 py-1.5 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-lg text-[10px] font-bold active:scale-95 transition-transform flex items-center gap-1"
                        >
